...
@Tag(name = "사용자 API", description = "로그인한 사용자 정보 관리")
@RestController
...
public class UserController {
  ...
  @Operation(summary = "내 정보 조회", description = "현재 로그인된 사용자의 정보 조회",
  ...
  @Operation(summary = "내 정보 수정", description = "현재 로그인된 사용자의 프로필 정보 수정",
      security = @SecurityRequirement(name = "bearerAuth"))
  @PutMapping("/me")
  ...
  @Operation(summary = "회원 탈퇴", description = "현재 로그인된 사용자 탈퇴 처리",
      security = @SecurityRequirement(name = "bearerAuth"))
  @DeleteMapping("/me")
